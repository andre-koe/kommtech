...
class ComplexSequence:
    ...
    def autocorrelation(self, shifts=None, normalized=False):
        r"""
        Returns the autocorrelation $R[\ell]$ of the complex sequence. See [`komm1.autocorrelation`](/ref/autocorrelation) for more details.
    ...
    def cyclic_autocorrelation(self, shifts=None, normalized=False):
        r"""
        Returns the cyclic autocorrelation $\tilde{R}[\ell]$ of the complex sequence. See [`komm1.cyclic_autocorrelation`](/ref/cyclic_autocorrelation) for more details.
