...
class BinarySequence:
    ...
    def __init__(self, bit_sequence=None, polar_sequence=None):
        ...
        Examples:
            ...
            >>> seq = komm1.BinarySequence(bit_sequence=[0, 1, 1, 0])
            >>> seq.bit_sequence
            array([0, 1, 1, 0])
            >>> seq.polar_sequence
            array([ 1, -1, -1,  1])

            >>> seq = komm1.BinarySequence(polar_sequence=[1, -1, -1, 1])
            >>> seq.bit_sequence
            array([0, 1, 1, 0])
            >>> seq.polar_sequence
            array([ 1, -1, -1,  1])
    ...
    def autocorrelation(self, shifts=None, normalized=False):
        r"""
        Returns the autocorrelation $R[\ell]$ of the binary sequence in polar format. See [`komm1.autocorrelation`](/ref/autocorrelation) for more details.

        Parameters:

            shifts (Optional[Array1D[int]]): See [`komm1.autocorrelation`](/ref/autocorrelation). The default value yields $[0 : L)$.

            normalized (Optional[bool]): See [`komm1.autocorrelation`](/ref/autocorrelation). The default value is `False`.
    ...
    def cyclic_autocorrelation(self, shifts=None, normalized=False):
        r"""
        Returns the cyclic autocorrelation $\tilde{R}[\ell]$ of the binary sequence in polar format. See [`komm1.cyclic_autocorrelation`](/ref/cyclic_autocorrelation) for more details.

        Parameters:

            shifts (Optional[Array1D[int]]): See [`komm1.cyclic_autocorrelation`](/ref/cyclic_autocorrelation). The default value yields $[0 : L)$.

            normalized (Optional[bool]): See [`komm1.cyclic_autocorrelation`](/ref/cyclic_autocorrelation). The default value is `False`.
