...
class ConvolutionalCode:
    ...
    def __init__(self, feedforward_polynomials, feedback_polynomials=None):
        ...
        Examples:
            ...
            >>> code = komm1.ConvolutionalCode(feedforward_polynomials=[[0o117, 0o155]])
            ...
            >>> code = komm1.ConvolutionalCode(feedforward_polynomials=[[0o31, 0o27, 0o00], [0o00, 0o12, 0o15]])
            >>> (code.num_output_bits, code.num_input_bits, code.overall_constraint_length)
            (3, 2, 7)
            ...
            >>> code = komm1.ConvolutionalCode(feedforward_polynomials=[[0o27, 0o31]], feedback_polynomials=[0o27])
            >>> (code.num_output_bits, code.num_input_bits, code.overall_constraint_length)
            (2, 1, 4)
        """
