...
class APSKModulation(Modulation):
    ...
    def __init__(self, orders, amplitudes, phase_offsets=0.0, labeling="natural"):
        ...
        Examples:
            ...
            >>> apsk = komm1.APSKModulation(orders=(8, 8), amplitudes=(1.0, 2.0), phase_offsets=(0.0, np.pi/8))
            ...
            >>> apsk = komm1.APSKModulation(orders=(4, 12), amplitudes=(np.sqrt(2), 3.0), phase_offsets=(np.pi/4, 0.0))
            >>> np.around(apsk.constellation, decimals=4)
