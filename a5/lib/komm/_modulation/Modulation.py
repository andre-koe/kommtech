...
class Modulation:
    ...
    def __init__(self, constellation, labeling):
        ...
        Examples:
            ...
            >>> komm1.Modulation(constellation=[-0.5, 0.0, 0.5, 2.0], labeling=[[1, 0], [1, 1], [0, 1], [0, 0]])
            ...
            >>> komm1.Modulation(constellation=[0, -1, 1, 1j], labeling=[[0, 0], [0, 1], [1, 0], [1, 1]])
    ...
    def constellation(self):
        ...
        Examples:
            ...
            >>> mod = komm1.Modulation(constellation=[-0.5, 0.0, 0.5, 2.0], labeling=[[1, 0], [1, 1], [0, 1], [0, 0]])
            >>> mod.constellation
            array([-0.5,  0. ,  0.5,  2. ])
        """
    ...
    def energy_per_symbol(self):
        ...
        Examples:
            ...
            >>> mod = komm1.Modulation(constellation=[0, -1, 1, 1j], labeling=[[0, 0], [0, 1], [1, 0], [1, 1]])
            >>> mod.energy_per_symbol
            0.75
        """
