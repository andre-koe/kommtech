...
class BinaryPolynomial:
    ...
    Examples:
        ...
        >>> poly1 = komm1.BinaryPolynomial(0b10100)  # X^4 + X^2
        >>> poly2 = komm1.BinaryPolynomial(0b11010)  # X^4 + X^3 + X
    ...
    def __init__(self, integer):
        ...
        Examples:
            ...
            >>> komm1.BinaryPolynomial(0b11010)  # X^4 + X^3 + X
    ...
    def from_coefficients(cls, coefficients):
        ...
        Examples:
            ...
            >>> komm1.BinaryPolynomial.from_coefficients([0, 1, 0, 1, 1])  # X^4 + X^3 + X
            BinaryPolynomial(0b11010)
        """
    ...
    def from_exponents(cls, exponents):
        ...
        Examples:
            ...
            >>> komm1.BinaryPolynomial.from_exponents([1, 3, 4])  # X^4 + X^3 + X
            BinaryPolynomial(0b11010)
        """
    ...
    def degree(self):
        ...
        Examples:
            ...
            >>> poly = komm1.BinaryPolynomial(0b11010)  # X^4 + X^3 + X
            >>> poly.degree
            4
        """
