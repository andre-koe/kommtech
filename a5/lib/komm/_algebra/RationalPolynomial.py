...
class RationalPolynomial:
    ...
    Examples:
        ...
        >>> poly1 = komm1.RationalPolynomial(['1/2', '0', '3'])  # 1/2 + 3 X^2
        >>> poly1
        RationalPolynomial(['1/2', '0', '3'])
        >>> poly2 = komm1.RationalPolynomial(['1/3', '2/3'])  # 1/3 + (2/3) X
        >>> poly2
    ...
    def __init__(self, coefficients):
        ...
        Examples:
            ...
            >>> komm1.RationalPolynomial(['1/2', '0', '3'])  # 1/2 + 3 X^2
            RationalPolynomial(['1/2', '0', '3'])
        """
    ...
    def monomial(cls, degree, coefficient=1):
        ...
        Examples:
            ...
            >>> komm1.RationalPolynomial.monomial(4, 2)  # 2 X^4
    ...
    def coefficients(self, width=None):
        ...
        Examples:
            ...
            >>> poly = komm1.RationalPolynomial(['0', '1/3', '2/3'])  # (1/3) X + (2/3) X^2
            >>> poly.coefficients()
    ...
    def degree(self):
        ...
        Examples:
            ...
            >>> poly = komm1.RationalPolynomial([1, 0, 3])  # 1 + 3 X^2
            >>> poly.degree
            2
        """
    ...
    def evaluate(self, point):
        ...
        Examples:
            ...
            >>> poly = komm1.RationalPolynomial([0, 1, 0, -1, 2])  # X - X^3 + 2 X^4
