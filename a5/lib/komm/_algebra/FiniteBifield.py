...
class FiniteBifield:
    ...
    def __init__(self, degree, modulus=None):
        ...
        Examples:
            ...
            >>> field = komm1.FiniteBifield(4, modulus=0b11001)
            >>> field
